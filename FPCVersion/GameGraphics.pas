...
interface
  ...
  type
    ...
    TByteCount = 0..(High(TPixelArea) * PIXELSIZE);
  ...
  implementation
    ...
    procedure FillPixelBuffer(const pixelBuffer: PPixelBuffer; const windowData: TWindowData); inline;
    begin
    ...
    procedure EnableGraphicProcessing(const pixelBuffer: PPixelBuffer; const windowData: TWindowData); inline;
    begin
